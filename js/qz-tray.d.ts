declare module "qz-tray" {
    ...
    type Promiser = (resolver: () => void) => void;
    type Hasher = (message: () => void) => void;
    type Ws = (webSocket: () => void) => void;
    ...
    type FileStopListeningParams
        = Pick<FileStartListeningParams, "sandbox" | "shared">
    ...
    type UsbCloseStreamDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId"> & {
        endpoint: string;
    }
    type UsbIsClaimedDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId">
    type ListEndpointsDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId"> & {
        iface: string;
    }
    type ListInterfacesDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId">
    type UsbOpenStreamDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId"> & {
        endpoint: string;
        responseSize: number;
        interval: number;
    }
    type UsbReleaseDeviceDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId">
    type UsbSendDataDeviceInfoInput = Pick<DeviceInfo, "vendorId" | "productId"> & {
        endpoint: string;
        productId: string;
        data: string;
        type?: Type;
    ...
    interface IHid {
        ...
        releaseDevice: (deviceInfo: HidReleaseDeviceDeviceInfoInput) => Promise<void>;
        sendData: (deviceInfo: HidSendDataDeviceInfoInput) => Promise<void>;
        sendFeatureReport: (deviceInfo: HidSendFeatureReportDeviceInfoInput) => Promise<void>;
    ...
    interface ISerial {
        ...
        sendPort: (
            port: string,
            data: string | string[] | SendPortData,
        ) => Promise<void>;
    ...
    interface IUsb {
        ...
        listEndpoints: (deviceInfo: ListEndpointsDeviceInfoInput) => Promise<string[]>;
        listInterfaces: (deviceInfo: ListInterfacesDeviceInfoInput) => Promise<string[]>;
        openStream: (deviceInfo: UsbOpenStreamDeviceInfoInput) => Promise<void>;
        releaseDevice: (deviceInfo: UsbReleaseDeviceDeviceInfoInput) => Promise<void>;
