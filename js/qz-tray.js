...
///// PUBLIC METHODS /////
    ...
    var qz = {
         ...
         *   @param {boolean} [data.options.ignoreTransparency] Optional with <code>[pdf]</code> formats. If transparent elements should be ignored in rendering.
         *       If transparency is not ignored rasterization may be forced by the internal renderer.
