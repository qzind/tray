...
public class PrintOptions {
    ...
    public enum Orientation {
        ...
        LANDSCAPE(OrientationRequested.LANDSCAPE, PageOrientation.LANDSCAPE, 270),
        REVERSE_LANDSCAPE(OrientationRequested.REVERSE_LANDSCAPE, PageOrientation.REVERSE_LANDSCAPE, 90);
