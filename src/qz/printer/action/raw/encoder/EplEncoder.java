...
public class EplEncoder implements ImageEncoder {
    private final int x;
    private final int y;

    public EplEncoder(int x, int y) {
        this.x = x;
        this.y = y;
    }
    ...
    public byte[] encode(ImageConverter imageConverter) throws IOException {
        ...
        return byteBuffer.append("GW", x, ",", y, ",", w, ",", h, converter.getImageAsBitSet().toByteArray(), "\n").toByteArray();
    }
}
